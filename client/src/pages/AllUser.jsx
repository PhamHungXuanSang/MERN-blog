...
export default function AllUser() {
    ...
    return (
        <div>
            <div className="flex flex-col gap-4 py-8 px-4 container mx-auto">
                        ...
                        <>
                            {users.map((item, i) => (
                                <div key={i} className="w-full rounded-lg">
                                    <div
                                        className={
                                            'group w-full overflow-hidden md:w-[60%] hover:w-full hover:cursor-pointer duration-500 dark:bg-slate-800 bg-slate-100 rounded-lg p-4' +
