    ...
    return (
        <div
            className={
                ...
                ' duration-700 max-sm:right-0 sm:top-0 w-[50%] h-full z-50 bg-white shadow-2xl md:p-8 py-4 px-2 overflow-y-auto overflow-x-hidden'
            }
        >
            <div className="relative">
                <h1 className="text-xl font-medium">Comments</h1>
                <p className="text-lg mt-2 w-[88%] line-clamp-1">{title}</p>
                <button
                    onClick={() => setCommentsWrapper((preValue) => !preValue)}
                    className="absolute top-0 right-0 flex justify-center items-center md:w-10 md:h-10 w-8 h-8 rounded-full bg-gray-200"
                >
