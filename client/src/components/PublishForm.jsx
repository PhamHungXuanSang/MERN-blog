                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <div className="relative w-[100%] rounded-md p-4 bg-grey pl-12 border border-grey focus:bg-transparent pl-2 py-2 pb-4">
                        <input
                            ...
                            type="text"
                            placeholder="Topic"
                            className="sticky w-[100%] rounded-md p-4 dark:bg-[#374151] dark:text-gray-400 pl-12 border border-grey focus:bg-transparent bg-white top-0 left-0 pl-4 mb-3 focus:bg-white"
                        />
                        {tags.map((tag, i) => {
